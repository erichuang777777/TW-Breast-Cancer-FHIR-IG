...
- pytest：294 passed（新增 OID assignment、TCR 術語 backlog、逐 Measure、46 個 StructureDefinition 與 152 個 terminology artifact 的規格／簽核完整性、全 IG scope claims／決策、template supply-chain 與八項 release-control 證據一致性檢查）。
