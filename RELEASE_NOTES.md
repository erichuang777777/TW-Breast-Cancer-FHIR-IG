...
- pytest：286 passed（新增 OID assignment、TCR 術語 backlog、逐 Measure 與 46 個 StructureDefinition 規格／簽核完整性、全 IG scope claims／決策、template supply-chain 與八項 release-control 證據一致性檢查）。
