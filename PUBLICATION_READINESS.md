...
| Gate | 結果 | 說明 |
|---|---:|---|
| pytest | pass：232 tests | 包含 mapping、PHI、CQL、IG export、Publisher warning policy 與 publication workflow 契約測試。 |
...
| CQL branch assertions | partial：11/20 Measures | QI-01～QI-06 與 QR-01～QR-05 已通過具預期 population 結果的合成 R4 Bundle 分支案例；QR-04 仍受真實前年度 cohort 阻擋，QR-05 仍是候選規則，其餘 9 個分布 Measure 尚缺完整 assertions。 |
...
3. **Measure 可執行性**：20 個 Measure 目前有 QI-01～QI-06 與 QR-01～QR-05 的具預期值合成分支測試；QR-04 尚需真實前年度 cohort，QR-05 尚需人工 truth set，其餘 9 個分布 Measure 仍須完成 stratifier value、missing、out-of-domain 與 boundary cases。
