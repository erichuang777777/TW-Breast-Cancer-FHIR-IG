...
| Computable Measure Preview | block | 20/20 Measure、46 個 criteria 已完成 ELM runtime smoke；`bc-qi-01`～`bc-qi-06` 已完成具預期值的合成分支測試，但其餘 14 個 Measure 尚未完成，且 19 個臨床 ValueSet 為空。 |
...
- Translation 與最小 runtime smoke 已達 20/20 Measure、46/46 criteria；具預期值的 positive／negative／exclusion／missing／boundary 分支驗證目前為 6/20 Measure（QI-01～QI-06）。
