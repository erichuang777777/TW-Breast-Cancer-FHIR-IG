...
| Computable Measure Preview | block | 20/20 Measure、46 個 criteria 已完成 ELM runtime smoke；QI-01～QI-06 與 QR-01～QR-02 已完成具預期值的合成分支測試，但其餘 12 個 Measure 尚未完成，且 19 個臨床 ValueSet 為空。 |
...
- Translation 與最小 runtime smoke 已達 20/20 Measure、46/46 criteria；具預期值的合成分支驗證目前為 8/20 Measure（QI-01～QI-06、QR-01～QR-02）。
