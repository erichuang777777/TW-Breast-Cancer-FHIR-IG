...
- Added a draft v2 fillable web-template contract and a PHI-free Care Plan JSON-to-QBC coverage matrix; the January baseline now produces 51 of 115 QBC fields after removing the invalid all-type-2 default and applying the reviewed treatment-order/M1 classification rule.
